    ...
    <div className="min-h-screen pb-20">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <div className="relative">
              <input 
                type="text" placeholder="Buscar colección..." className="bg-slate-100 border-none rounded-2xl py-2.5 pl-11 pr-5 w-80 text-sm focus:ring-2 focus:ring-indigo-500/20 outline-none"
                onChange={(e) => { setSearch(e.target.value); fetchProducts(e.target.value); }}
              />
              <Search className="absolute left-4 top-3 text-slate-400" size={16} />
            </div>
            <button onClick={() => { setEditingProduct(null); setIsModalOpen(true); }} className="bg-slate-900 text-white px-5 py-2.5 rounded-2xl font-semibold text-sm hover:bg-indigo-600 transition-all flex items-center gap-2">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-12">
        <div className="mb-12">
          ...
          <p className="text-slate-500 font-medium">Gestiona tu inventario con diseño de alta gama.</p>
        </div>
